                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full"
                                                            src="{{ asset('images/book-image.jpg') }}" alt="">
                                                    </div>
                                                    <div class="ml-4">
                                                        <div
                                                            class="text-sm font-medium text-gray-900 overflow-ellipsis overflow-hidden truncate">
                                                            {{ $item->book?->title }}
                                                        </div>
                                                    </div>
                                                </div>
